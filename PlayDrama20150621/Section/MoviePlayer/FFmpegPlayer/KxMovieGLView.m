...
//texture2D:使用纹理坐标v_texcoord在由s_texture当前指定的2d纹理中执行纹理查找，
...
//openGL的shader给显卡运行的, 片段着色器把YUV格式的转成RGB
             ...
             decoder: (KxMovieDecoder *) decoder
{
    ...
    if (self) {
        ...
        //以下代码也可通过GLKView实现 。目的是优化绘图，减轻工作量.
        //关于open GLES:http://blog.csdn.net/dreamcs/article/details/7691690
        ...
        //检查fbo(framebufferobject)的状态
        //glCheckFramebufferStatus()检查当前帧缓存的关联图像和帧缓存参数。
