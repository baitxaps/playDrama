...
+ (AFHTTPRequestOperation *)UploadDataWithUrlString:(NSString *)URLString
    ...
    // 设置请求类型
    //  NSString *sizeString = [NSString stringWithFormat:@"%@",parameters[@"fileSize"]];
    //-------------------------------
    //[manager.requestSerializer setValue:@"video/mp4" forHTTPHeaderField:@"Content-Type"];
    //[manager.requestSerializer setValue:sizeString forHTTPHeaderField:@"Content-Length"];
    //[manager.requestSerializer setValue:@"http://up.qiniu.com" forHTTPHeaderField:@"Host"];
    //-------------------------------
    manager.requestSerializer                         = [Networking requestSerializerWith:requestType];
